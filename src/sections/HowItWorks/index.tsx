    ...
    <WithIntersectionObserver callback={memoizedCallback}>
      <Container id="howitowork" className="limit">
        ...
        <h2 className="subtitle">
          ...
          busca visual que ajuda essas pessoas a encontrarem ideias que têm tudo
          a ver com elas. <br />
          <br /> Nem todo mundo consegue descrever o que está procurando, mas
          todo mundo sabe reconhecer uma ideia incrível. Enquanto navegam pelo
