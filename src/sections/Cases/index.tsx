            ...
            <div className="cases">
              <div className="cases__item">
                ...
                <p className="card__paragraph">
                  O Pinterest Trends ajudou a empresa a elaborar criativos novos
                  e impactantes, com um custo por aquisição 4 vezes mais baixo
                  do que seus indicadores internos mostravam.1
                </p>
              ...
              <div className="cases__item">
                ...
                <p className="card__paragraph">
                  Com a ajuda do Pinterest, a especialista em moda e viagens
                  ganhou 148% mais seguidores em um mês e se conectou com um
                  público muito engajado.2
                </p>
